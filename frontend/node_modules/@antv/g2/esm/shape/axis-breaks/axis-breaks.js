...
export const AxisBreaks = (options, params) => {
    ...
    const { scale } = view;
    return (option) => {
        const { key, start, end, gap = BREAKS_GAP, vertices = 50, lineWidth = 0.5, verticeOffset = 3 } = option, style = __rest(option, ["key", "start", "end", "gap", "vertices", "lineWidth", "verticeOffset"]);
